...
public class MypageCommand implements Command {
	...
	public CommandResult execute(HttpServletRequest request,
		 ...
		 * System.out.println("웹툰 카운트 실행"); int count =
		 * this.doReadWebtoonCount(request, CurrentUser_facebookID);
		 * this.doSetUserGrade(CurrentUser_facebookID, count); commandResult =
		 * new CommandResult("text/plain", Integer.toString(count)); }
	...
	// 내가 본 웹툰 카운트
	/*
	 * public int doReadWebtoonCount(HttpServletRequest request, long
	 * CurrentUser_facebookID) throws ServletException, IOException {
	 * 
	 * return userWebtoonMpasService.doGetWebtoonCount(CurrentUser_facebookID);
	 * }
	 * 
	 * public void doSetUserGrade(long CurrentUser_facebookID, int count) throws
	...
	// 내가 본 웹툰
	/*
	 * public void doMypageReadWebtoon(HttpServletRequest request, long
	 * CurrentUser_facebookID) throws ServletException, IOException {
	 * 
	...
	// 신작 웹툰
	/*
	 * public void doRecommendNew(HttpServletRequest request, long
	 * CurrentUser_facebookID) throws ServletException, IOException {
	 * 
	...
	// 찜한 웹툰
	/*
	 * public void doViewWishList(HttpServletRequest request, long
	 * CurrentUser_facebookID) throws ServletException, IOException {
	 * 
	 * List<WebtoonVO> webtoonVO = webtoonService
