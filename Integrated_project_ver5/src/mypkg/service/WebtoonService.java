...
public class WebtoonService {
	...
	public String doGetWebtoonsAuthors(long users_facebookID_pk, String authors_name) {
		...
		String webtoonAuthor = this.getWebtoonsAuthors(users_facebookID_pk, author_name);
		Gson gson = new Gson();
	...
	public String getWebtoonsAuthors(long users_facebookID_pk, String author_name) {
